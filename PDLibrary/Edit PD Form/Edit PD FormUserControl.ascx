...
<div id="main" class="mainDiv">
    ...
    <div id="EditPDForm" runat="server">
        <h3 class="volpe">New Position Description</h3>
        <br />
        <asp:TextBox ID="txtHiddenID" runat="server" ReadOnly="true" Enabled="false" Visible="false" Width="10px"></asp:TextBox>
        <label id="lblPDNumber" for="txtPDNumber" class="volpeLabel">Position Description Number: </label><br />
        ...
        <br />
        <br />
        <label id="lblJobTitle" for="txtJobTitle" class="volpeLabel">Title: </label>
        ...
        <br />
        <br />
        <label id="lblGrade" for="ddGrade" class="volpeLabel">Pay Grade: </label><br />
        ...
        <br />
        <br />
        <label id="lblOcupationalSeries" for="ddSeries" class="volpeLabel">Occupational Series: </label><br />
        ...
        <br />
        <br />
        <label id="lblPositionType" for="ddPositionType" class="volpeLabel">Position type: </label><br />
        ...
        <br />
        <br />
        <label id="lblOrganization" for="ddOrganization" class="volpeLabel">Organization: </label><br />
        ...
        <br />
        <br />
        <label id="lblSupervisoryPosition" for="rdblSupervisoryPosition" class="volpeLabel">Is this a supervisory position? </label>
        ...
        <br />
        <br />
        <label id="lblNotes" for="txtNotes" class="volpeLabel">Notes: </label>
        ...
        <br />
        <br />
        <label id="lblWordFile" for="fuWordFile" class="volpeLabel">Position Description (WORD) Upload: </label>
        &nbsp;
        ...
        <div id="divCurrentWordFile" runat="server">
            <label id="lblCurrentWordFile" for="hlkWordFile" class="volpeLabel">Current: </label>
        ...
        <br />
        <br />
        <label id="lblPDFFile" for="fuPDFFile" class="volpeLabel">Position Description (PDF) Upload: </label>
        &nbsp;
        ...
        <div id="divCurrentPDFFile" runat="server">
            <label id="lblCurrentPDFFile" for="hlkPDFFile" class="volpeLabel">Current: </label>
        ...
        <br />
        <br />
        <label id="lblCoversheetFile" for="fuOF8File" class="volpeLabel">Coversheet (OF-8) Upload: </label><br />
        <div id="divCurrentCoversheetFile" runat="server">
            <label id="lblCurrentCoversheetFile" for="hlkCoversheetFile" class="volpeLabel">Current: </label>
        ...
        <br />
        <br />
        <label id="lblJAFFile" for="fuJAFFile" class="volpeLabel">Job Analysis Form Upload: </label><br />
        <div id="divCurrentJAFFile" runat="server">
            <label id="lblCurrentJAFFile" for="hlkJAFFile" class="volpeLabel">Current: </label>
        ...
        <br />
        <br />
        <label id="lblWSRVQFile" for="fuWSRVQFile" class="volpeLabel">Weight and Screenout Report / Vacancy Questions Upload: </label><br />
        <div id="divCurrentWSRVQFile" runat="server">
            <label id="lblCurrentWSRVQFile" for="hlkWSRVQFile" class="volpeLabel">Current: </label>
        ...
        <br />
        <br />
        <label id="lblKSAFile" for="fuKSAFile" class="volpeLabel">KSA Form Upload: </label><br />
        <div id="divCurrentKSAFile" runat="server">
            <label id="lblCurrentKSAFile" for="hlkKSAFile" class="volpeLabel">Current: </label>
        ...
        <br />
        <br />
        <label id="lblSEFFile" for="fuSEFFile" class="volpeLabel">Specialized Experience File Upload: </label><br />
        <div id="divCurrentSEFFile" runat="server">
            <label id="lblCurrentSEFFile" for="hlkSEFFile" class="volpeLabel">Current: </label>
        ...
        <div id="divCurrentOtherFile" runat="server">
            <label id="lblCurrentOtherFile" for="hlkOtherFile" class="volpeLabel">Current: </label>
            <asp:HyperLink ID="hlkOtherFile" runat="server" Font-Underline="true" ForeColor="Blue" Target="_blank">HyperLink</asp:HyperLink>
        </div>
        <label id="lblOtherFile" for="fuOtherFile" class="volpeLabel">Other Documents Upload: </label><br />
...
<div id="actionsDiv" runat="server" class="actionsDiv">
    <label id="lblActions" for="ddActions" class="volpeLabel">Actions:</label><br />
    <br />    
