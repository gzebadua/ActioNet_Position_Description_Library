...
<div id="main" class="mainDiv">
    ...
    <div id="searchPDForm" runat="server">
        <h3 class="volpe">Search for a Position Description</h3>
        <h4 class="volpe">Search for a Position Description (enter one or more values and click 'Search')</h4>
        <br />
        <label id="lblJobTitle" for="txtJobTitle" class="volpeLabel">Free Form Title Search: </label><br />
        ...
        <br />
        <br />
        <label id="lblJobTitleDropdown" for="ddJobTitle" class="volpeLabel">Choose a Title from the list: </label><br />
        ...
        <table width="400px">
            <tr>
                ...
                <td>
                    <label id="lblPDNumber" for="txtPDNumber" class="volpeLabel">PD #: </label><br />
