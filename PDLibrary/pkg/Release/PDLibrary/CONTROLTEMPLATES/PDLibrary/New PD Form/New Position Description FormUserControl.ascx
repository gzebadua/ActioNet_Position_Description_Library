...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="New Position Description FormUserControl.ascx.cs" Inherits="PDLibrary.New_Position_Description_Form.New_Position_Description_FormUserControl" %>
<style type="text/css">
    .mainDiv 
    {
        width:100%;
...
<div id="actionsDiv" runat="server" class="actionsDiv">
    ...
    <br />    
    <asp:DropDownList ID="ddActions" runat="server" Width="300px" ValidationGroup="NewPD">
...
<div id="main" class="mainDiv">
    <h2>Position Description Library Administration</h2>
    <div id="newPDForm" runat="server">
        ...
        <a href="EditTitleList.aspx"><asp:Label ID="lblPDTitlesLink" runat="server" Text="(Edit the Title List)" TabIndex="-1"></asp:Label></a><br />
...
<%--        <br />
        ...
        <br />
        <br />
        <asp:FileUpload ID="fuPDFFile" runat="server" Width="300px" filter="Word Files | .doc, .docx" /><br />
        <br />
